...
from transformers import HyperMixerTokenizer, HyperMixerTokenizerFast
...
@require_tokenizers
class HyperMixerTokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    tokenizer_class = HyperMixerTokenizer
    rust_tokenizer_class = HyperMixerTokenizerFast
    ...
    def setUp(self):
        ...
        tokenizer = HyperMixerTokenizer(SAMPLE_VOCAB)
    ...
    def test_full_tokenizer(self):
        tokenizer = HyperMixerTokenizer(SAMPLE_VOCAB, keep_accents=True)
    ...
    def test_tokenizer_integration(self):
        ...
        self.tokenizer_integration_test_util(
            ...
            model_name="google/hypermixer-base",
